# com-chilipeppr-workspace-mongooseIDE
A ChiliPeppr Workspace to test connection to Mongoose OS enabled esp32.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / mongooseIDE
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-mongooseIDE |
| Name                  | Workspace / mongooseIDE |
| Description           | A ChiliPeppr Workspace to test connection to Mongoose OS enabled esp32. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/jeffapv/workspace-mongooseIDE/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/jeffapv/mongoose_os |
| Github URL            | http://github.com/jeffapv/workspace-mongooseIDE |
| Test URL              | https://preview.c9users.io/jeffapv/mongoose_os/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/jeffapv/workspace-mongooseIDE/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-mongooseIDE"], // the id you gave your workspace
      function(myWorkspaceMongooseIDE) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / mongooseIDE just got loaded.", myWorkspaceMongooseIDE);
        myWorkspaceMongooseIDE.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-mongooseIDE"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / mongooseIDE"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace to test connection to Mongoose OS enabled esp32."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/jeffapv/workspace-mongooseIDE/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/jeffapv/mongoose_os"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/jeffapv/workspace-mongooseIDE"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://mongoose_os-jeffapv.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
