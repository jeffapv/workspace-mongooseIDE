...
cprequire_test(["inline:com-chilipeppr-workspace-mongooseIDE"], function(ws) {
    ...
    $('title').html("mongooseIDE Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-mongooseIDE", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-mongooseIDE", // Make the id the same as the cpdefine id
        name: "Workspace / mongooseIDE", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace to test connection to Mongoose OS enabled esp32.`,
